...
(defun forward-propagate (datum w)
...
;; IMPLEMENT THIS FUNCTION
(defun back-propagate (datum1 alpha w)
...
returning a list consisting of new, modified V and W matrices."
  ...
  ;; same let* statement.
  (let* ((o nil) (sig-list-o nil) (delta-w nil) term1 term2 i j (w-delta-w nil) (ew nil) (label nil) (datum nil))
    ;; split the data and label
    (setf datum (first datum1))
    (setf label (first (rest datum1)))
    
    ;; calculate the value at hidden layer nodes
    (setf o (multiply w datum))
