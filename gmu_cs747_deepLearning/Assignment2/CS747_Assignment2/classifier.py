...
class Classifier(nn.Module):  
    ...
    def __init__(self, block=block):
        ...
        # adding block layers
        self.b_layer1 = self.make_layers(block, 3, in_channels=64, out_channels=128, stride=2)
        self.b_layer2 = self.make_layers(block, 3, in_channels=128, out_channels=256, stride=2)
