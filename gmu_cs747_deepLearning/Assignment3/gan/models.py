...
class Discriminator(torch.nn.Module):
    def __init__(self, input_channels=3):
        ...
        self.conv5 = SpectralNorm(nn.Conv2d(1024, 1, kernel_size=1, stride=1, padding=0, bias=False))
...
class Generator(torch.nn.Module):
    def __init__(self, noise_dim, output_channels=3):
        ...
        # self.fc1 = nn.Linear(self.noise_dim, 112)
        # self.fc2 = self.fc1.reshape(7, 4, 4)
        ...
        self.conv3_transpose = nn.ConvTranspose2d(512, 256, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv3_bn=nn.BatchNorm2d(256)
        self.conv4_transpose = nn.ConvTranspose2d(256, 128, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv4_bn=nn.BatchNorm2d(128)
        self.conv5_transpose = nn.ConvTranspose2d(128, 3, kernel_size=4, stride=2, padding=1, bias=False)
        self.leakyRelu = nn.LeakyReLU(negative_slope=0.2)
        self.tan = nn.Tanh()
